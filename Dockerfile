...
RUN tdnf update -y && \
    ...
    tdnf install -y ansible bash ca-certificates cdrkit curl diffutils gawk git jq nodejs openssh python3 python3-jinja2 python3-paramiko python3-pip python3-pyyaml python3-resolvelib python3-xml shadow tar unzip vim && \
    # add user/group
